...
public class ToolData : Singleton<ToolData>
{
    ...
    {
        {1001, new Dictionary<string, string>(){ {"Name", "Gloves"}, {"MaxClean", "8"}, {"PosOffset", "0,0,0"}, {"RotOffset", "0,0,0"}, {"PrefabPath", "CleanTools/CleanTools_Gloves"}, {"IconPath", "GetPrefabPath"}, {"AnimationTrigger", "Clean"}, } },
        ...
        {1005, new Dictionary<string, string>(){ {"Name", "Rag"}, {"MaxClean", "4"}, {"PosOffset", "0,0,0"}, {"RotOffset", "0,0,0"}, {"PrefabPath", "CleanTools/CleanTools_Rag"}, {"IconPath", "GetPrefabPath"}, {"AnimationTrigger", "Clean"}, } },
    };
